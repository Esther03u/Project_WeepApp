...
@section('title', 'สร้างกิจกรรมใหม่ | ระบบลงทะเบียนกิจกรรม')
                ...
                <form action="{{ route('admin.activities.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="datetime-local" class="form-control @error('activity_date') is-invalid @enderror" id="activity_date" name="activity_date" value="{{ old('activity_date') }}" required>
                            @error('activity_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
